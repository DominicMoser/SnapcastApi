...
import com.dmoser.codyssey.snapcast.api.request.client.*;
import com.dmoser.codyssey.snapcast.api.request.group.OnMuteNotification;
import com.dmoser.codyssey.snapcast.api.request.group.OnStreamChangedNotification;
import com.dmoser.codyssey.snapcast.api.request.server.OnUpdateNotification;
import com.dmoser.codyssey.snapcast.api.request.stream.OnPropertiesNotification;
...
public enum NotificationMethod {
    ...
    GROUP_ON_NAME_CHANGED("Group.OnNameChanged", com.dmoser.codyssey.snapcast.api.request.group.OnNameChangedNotification.class),

    STREAM_ON_PROPERTIES("Stream.OnProperties", OnPropertiesNotification.class),
    STREAM_ON_UPDATE("Stream.OnUpdate", com.dmoser.codyssey.snapcast.api.request.stream.OnUpdateNotification.class),
    ...
    CLIENT_ON_NAME_CHANGED("Client.OnNameChanged", OnNameChangedNotification.class);
