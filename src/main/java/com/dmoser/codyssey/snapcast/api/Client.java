...
import com.dmoser.codyssey.snapcast.api.request.client.SetLatency;
import com.dmoser.codyssey.snapcast.api.request.client.SetName;
...
public class Client extends ApiEndpoint {
     ...
     * @since 2.0.0
     */
    public List<com.dmoser.codyssey.snapcast.api.model.group.Client> getAllClients() {
