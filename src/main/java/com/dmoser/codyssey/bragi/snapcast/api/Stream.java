...
import com.dmoser.codyssey.bragi.snapcast.api.request.stream.AddStream;
import com.dmoser.codyssey.bragi.snapcast.api.request.stream.Control;
import com.dmoser.codyssey.bragi.snapcast.api.request.stream.RemoveStream;
...
public class Stream extends ApiEndpoint {
    ...
    public com.dmoser.codyssey.bragi.snapcast.api.model.Stream get(String streamId) {
    ...
    public List<com.dmoser.codyssey.bragi.snapcast.api.model.Stream> getAllStreams() {
        return state.getStreams();
    }
}
